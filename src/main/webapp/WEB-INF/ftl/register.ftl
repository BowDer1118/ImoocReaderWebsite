...
<body>
        ...
        <div class="container mt-2 p-2 m-0">
            <form id="frmLogin">
                <div class="passport bg-white">
                    ...
                    <a id="btnSubmit"
                        class="btn btn-success  btn-block mt-4 text-white pt-3 pb-3">註&nbsp;&nbsp;&nbsp;&nbsp;冊</a>
                </div>
            </form>
    ...
    <script>
        ...
        function reloadVerifyCode() {
            //請在這里實現刷新驗證碼
            //設置src屬性的數值:在url中增加時間戳記，避免response被瀏覽器緩存
        ...
        $("#btnSubmit").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    //結果處理,根據服務器返回code判斷服務器處理狀態
                    //服務器要求返回JSON格式:
                    //{"code":"0","msg":"處理消息"}
                    console.info("服務器響應:", data);
                    if (data.code == "0") {
                        //顯示註冊成功對話框
